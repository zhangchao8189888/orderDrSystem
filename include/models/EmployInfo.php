 ...
 * @property string $e_phone_no
 * @property string $e_biye_xuexiao
 * @property string $add_time
 * @property string $e_work_address
 */
class EmployInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, employ_id, e_birthday, e_is_marriage, e_zhengzmianmao, e_education_best, e_word_start_day, e_sex, e_phone_no, add_time', 'required'),
			array('id, employ_id, e_is_marriage, e_zhengzmianmao, e_education_best, e_sex', 'numerical', 'integerOnly'=>true),
			array('e_jiguan, e_hukou, e_work_address', 'length', 'max'=>100),
			array('e_bank_no, e_phone_no, e_biye_xuexiao', 'length', 'max'=>30),
			...
			array('id, employ_id, e_jiguan, e_bank_no, e_birthday, e_hukou, e_is_marriage, e_county, e_zhengzmianmao, e_education_best, e_word_start_day, e_dangan_bianhao, e_yuangong_bianhao, e_shebao_no, e_sex, e_gongzuodi, e_minzu, e_phone_no, e_biye_xuexiao, add_time, e_work_address', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'e_minzu' => 'E Minzu',
			'e_phone_no' => 'E Phone No',
			'e_biye_xuexiao' => 'E Biye Xuexiao',
			'add_time' => 'Add Time',
			'e_work_address' => 'E Work Address',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('e_phone_no',$this->e_phone_no,true);
		$criteria->compare('e_biye_xuexiao',$this->e_biye_xuexiao,true);
		$criteria->compare('add_time',$this->add_time,true);
		$criteria->compare('e_work_address',$this->e_work_address,true);
